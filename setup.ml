...
(* OASIS_START *)
(* DO NOT EDIT (digest: 899edb72f7c57a2463426af49c5b03d2) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build modules which depend on Containers";
               ...
               Library
                 ({
                     cs_name = "monomorphic-containers";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "containers", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/containers";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "monomorphic";
                   ...
                   {
                      lib_modules = ["Monomorphic_containers"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "monomorphic";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\2540T\1563uG\rA\196o\191\212\160\0063";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
